    ...
    <Layout>
      <div className="w-screen max-w-lg flex flex-col my-5 items-center">
        <Carousel showThumbs={false} infiniteLoop={true} autoPlay={true}>
          <div className="h-60">
            <img src={scubadooPhoto2} alt="ScubaDoo" />
          </div>
          <div className="h-60">
            <img src={scubadooPhoto3} alt="ScubaDoo" />
          </div>
          <div className="h-60">
        ...
        <div className="flex flex-col items-center justify-center mt-5 space-y-1 mx-4">
          ...
          <h4 className="text-sm text-gray-500">Price: $70 per person</h4>
          <h4 className="text-sm text-gray-500">2.5 Hours Tour</h4>
        </div>
