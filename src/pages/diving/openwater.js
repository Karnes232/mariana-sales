        ...
        <div className="w-screen max-w-lg flex flex-col my-5 items-center">
          ...
          <div className="flex flex-col items-center justify-center mt-5 space-y-2 mx-4">
            ...
            <p className="text-sm text-gray-800 text-center">
              This is a 3-day diving course which will allow you to dive down to
              a maximum of 18 meters / 60 feet anywhere in the world. The course
              consists of 3 sections – online dive theory, confined swimming
          ...
          <div className="flex flex-col items-center justify-center my-5 space-y-2 mx-4">
            ...
            <p className="text-sm text-gray-800 text-center">
              At this point you will do your confined water training at one of
              our pools, with small groups you can complete all of your confined
              water training in one day.
            </p>
            <p className="text-sm text-gray-800 text-center">
              In your confined water dives you will learn all you need to know
              in how to use scuba equipment and be able to handle yourself under
              water as well as being prepared for any situation in the open
              water. We prefer to take a little more time with you in the pool
              so that you are 100% comfortable when you go diving in the open
              water. Not only will you learn a lot, you will a have a lot of fun
              swimming around under water.
            </p>
            <h4 className="text-lg font-semibold">Open Water Dives</h4>

            <p className="text-sm text-gray-800 text-center">
              The open water portion of the course consists of 4 open water
              dives where you will perform various dive skills both under water
              and at the surface to make sure that you are a competent and safe
              diver. We break up the skills over the 4 dives so that you only
              are doing a few skills each dive and get to spend the majority of
              your time diving with your instructor and exploring the underwater
              world.
            </p>
          </div>
          <ButtonBlueCTA
