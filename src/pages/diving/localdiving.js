      ...
      <div className="w-screen max-w-lg flex flex-col my-5 items-center">
        ...
        <div className="flex flex-col items-center justify-center my-5 mx-4 space-y-2">
          ...
          <p className="text-sm text-gray-800 text-center">
            ...
            <Link to="/diving/discover" className="no-underline text-blue-600">
              DSD (Discover Scuba Diving)
            </Link>{" "}
            program or a{" "}
            <Link to="/diving/openwater" className="no-underline text-blue-600">
              PADI diving course.
            </Link>
          </p>
          <p className="text-sm text-gray-800 text-center">
            ...
            the excursion to{" "}
            <Link to="/diving/catalina" className="no-underline text-blue-600">
              Catalina Island
            </Link>
