        ...
        <div className="w-screen max-w-lg flex flex-col mt-5 items-center">
          ...
          <div className="flex flex-col items-center justify-center mt-5 space-y-2 mx-4">
            ...
            <p className="text-sm text-gray-800 text-center">
              ...
              completing this course, you will have a certification to dive to
              12 meters / 40 feet under the supervision of a divemaster or
              instructor.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center my-5 space-y-2 mx-4">
            ...
            <p className="text-sm text-gray-800 text-center">
              The open water portion of the course consists of 2 open water
              ...
              diver. We break up the skills over the 2 dives so that you only
