        ...
        <div className="w-screen max-w-lg flex flex-col my-5 items-center">
          ...
          <div className="flex flex-col items-center justify-center mt-5 space-y-2 mx-4">
            ...
            <p className="text-sm text-gray-800 text-center">
              ...
              that let you get your hair wet and experience the underwater
              world.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center my-5 mx-4">
            <p className="text-sm text-gray-800 text-center">
              ...
              Scuba diving from 6 to a maximum of 12 meters, although it does
              not result in a certification, it can be credited as your first
              open water dive towards your PADI open water certification. This
              program is perfect for people who are interested in finding out
              what it is like to breath underwater and experience the underwater
              world.
            </p>
          </div>
          <ButtonBlueCTA
