...
import greatBigMable from "../../images/shortTours/mable.webp"
import greatBigMable2 from "../../images/shortTours/mable2.webp"
import bananaPhoto from "../../images/shortTours/banana.webp"
import bananaPhoto2 from "../../images/shortTours/banana2.webp"
import bananaPhoto3 from "../../images/shortTours/banana3.webp"
import bananaPhoto4 from "../../images/shortTours/banana4.webp"
    ...
    <Layout>
      <div className="w-screen max-w-lg flex flex-col mt-5 items-center">
        <Carousel showThumbs={false} infiniteLoop={true} autoPlay={true}>
          <div className="h-60">
            <img src={greatBigMable} alt="Great Big Mable" />
          </div>
          <div className="h-60">
            <img src={bananaPhoto} alt="Banana Boat" />
          </div>
          <div className="h-60">
            <img src={bananaPhoto2} alt="Banana Boat" />
          </div>
          <div className="h-60">
            <img src={bananaPhoto3} alt="Banana Boat" />
          </div>
          <div className="h-60">
            <img src={greatBigMable2} alt="Great Big Mable" />
          </div>
          <div className="h-60">
            <img src={bananaPhoto4} alt="Banana Boat" />
          </div>
        </Carousel>
        <div className="flex flex-col items-center justify-center mt-5 space-y-2 mx-4">
          <h1 className="text-2xl font-semibold">Towables</h1>
        ...
        <div className="flex flex-col items-center justify-center mt-5 space-y-1 mx-4">
          ...
          <h4 className="text-sm text-gray-500">Price: $15 per Person</h4>
